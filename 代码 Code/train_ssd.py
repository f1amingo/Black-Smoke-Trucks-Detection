...
def get_dataset(args):
    train_dataset = VOCLike(root=DATA_SET_ROOT, splits=((2019, 'train'),))
    val_dataset = VOCLike(root=DATA_SET_ROOT, splits=((2019, 'test'),))
...
if __name__ == '__main__':
    ...
    #     net = get_model(net_name, pretrained=False, norm_layer=gluon.contrib.nn.SyncBatchNorm,
    ...
    # else:
    net = get_model(net_name, pretrained=False, norm_layer=gluon.nn.BatchNorm, root='~/MyFiles/.mxnet/models')
    async_net = net
